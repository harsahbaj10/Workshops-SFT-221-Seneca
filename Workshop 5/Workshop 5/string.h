// this below is the header file and it was working fine and 
// for me it doesn't appear to be any bug in the header file provided as its the fragment porportion file .
#pragma once
#ifndef STRINGHELP_H
#define STRINGHELP_H
